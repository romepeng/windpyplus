...
from allAstock import allAstock
from mystocks import stocklists
from bigquantstocks import bqstocks
from convertToWindCode import convertBQCode
...
def info(stocklists):
    ...
    #df.to_excel("D:/Stock/tushare/info.xlsx", sheet_name = tradedate(0)[-1])
    #rm._play_wav()
    print(df.head())
    return df
...
if __name__ == '__main__':
	bqstock = convertBQCode(bqstocks)
